...
train_series = train_series.reshape(train_series.shape[0] * train_series.shape[1], train_series.shape[2],
                                    train_series.shape[3], train_series.shape[4])
...
test_series = test_series.reshape(test_series.shape[0] * test_series.shape[1], test_series.shape[2],
                                  test_series.shape[3], test_series.shape[4])
